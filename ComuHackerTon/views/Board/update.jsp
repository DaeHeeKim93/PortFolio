...
<html>
    ...
    <body>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <form name="writeForm" id="writeForm" action="/Board/board_update.com" method="post">
                <table>
                    <tbody>
                        <tr>
                            <th scope="row">
                                <input type="hidden" id="board_idx" name="board_idx" value="${BoardUpdate.board_idx}" />
                            ...
                            <td>
                                <div id="autosave_wrapper">
                                    <input type="text" class="frm_input required" id="board_title" name="board_title" value="${BoardUpdate.board_title}" maxlength="255"/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="wr_content">
                                <textarea name="board_context" id="board_context">
                                        ${BoardUpdate.board_context}
                                </textarea>
                            </td>
                        </tr>
                        <!--관리자 확인여부 체크 -->
                        <tr>
                            ...
                            <td><input type="checkbox" id="isSecret" name="isSecret" value="1"
                                    <c:if test="${BoardUpdate.isSecret eq '1'}">
                                        checked="checked"
                                    </c:if>
                ...
                <div class="down">
                    ...
                    <div class="col-md-2">
                        ...
                        <a class="btn btn-warning" id="select_button"  style="font-size : 15px" href="/Board/board_list_select.com">목록</a>
                    </div>
                    <div class="col-md=5"></div>
                </div>
            </form>
