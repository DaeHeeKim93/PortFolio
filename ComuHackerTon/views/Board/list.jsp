...
<html>
    ...
    <body>
        ...
        <!-- Navigation End -->
        <div class="container">
            <h2 class="title-1 m-b-10">자유게시판</h2>
            <br/>
            <br/>
            <div clas="row">
                ...
                <div class="col-md-10">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${BoardList}" var="BoardContents">
                                <tr class="bo_notice">
                                    <td class="td_num" width="25%" >${BoardContents.board_idx}</td>
                                    <td class="td_subject" width="25%">
                                        <a href="/Board/select.com?board_idx=${BoardContents.board_idx}"/>${BoardContents.board_title}
                                    </td>
                                    <td class="td_name sv_use" width="25%"><span class="sv_member">${BoardContents.board_id}</span></td>
                                    <td class="td_date" width="25%">${BoardContents.board_date}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="submit" class="au-btn au-btn-load js-load-btn" onclick="location.href='/Board/board_list_select.com?page=${page-1}'" value="이전페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn" onclick="location.href='/Board/board_list_select.com?page=${page+1}'" value="다음페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Board/board.com'" value="글 작성"></input>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
