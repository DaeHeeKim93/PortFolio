...
<html>
    ...
    <body>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <form name="writeForm" id="writeForm" action="/Report/report_update.com" method="post">
                <table>
                    <tbody>
                        <tr>
                            <!-- 게시글 idx hidden -->
                            <input type="hidden" id="report_idx" name="report_idx" value="${ReportUpdate.report_idx}" />
                            <th scope="row">
                            ...
                            <td>
                                <div id="autosave_wrapper">
                                    <input type="text" class="frm_input required" id="report_title" name="report_title" value="${ReportUpdate.report_title}" maxlength="255"/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="wr_content">
                                <textarea name="report_context" id="report_context">
                                        ${ReportUpdate.report_context}
                                </textarea>
                            </td>
                        </tr>
                        <!--관리자 확인여부 체크 -->
                        <tr>
                            ...
                            <td><input type="checkbox" id="isSecret" name="isSecret" value="1"
                                    <c:if test="${ReportUpdate.isSecret eq '1'}">
                                        checked="checked"
                                    </c:if>
                ...
                <div class="down">
                    ...
                    <div class="col-md-2">
                        ...
                        <a class="btn btn-warning" id="select_button"  style="font-size : 15px" href="/Report/report_list_select.com">목록</a>
                    </div>
                    <div class="col-md=5"></div>
                </div>
            </form>
