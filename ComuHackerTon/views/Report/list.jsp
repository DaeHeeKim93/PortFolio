...
<html>
    ...
    <body>
        ...
        <!-- Navigation End -->
        <div class="container">
            <h2 class="title-1 m-b-10">신고내용</h2>
            <br/>
            <br/>
            <div clas="row">
                ...
                <div class="col-md-10">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${ReportList}" var="ReportContents">
                                <tr class="bo_notice">
                                    <td class="td_num">${ReportContents.report_idx}</td>
                                    <td class="td_subject">
                                        <a href="/Report/select.com?report_idx=${ReportContents.report_idx}"/>${ReportContents.report_title}
                                    </td>
                                    <td class="td_name sv_use"><span class="sv_member">${ReportContents.report_id}</span></td>
                                    <td class="td_date">${ReportContents.report_date}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="submit" class="au-btn au-btn-load js-load-btn" onclick="location.href='/Report/report_list_select.com?page=${page-1}'" value="이전페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Report/report_list_select.com?page=${page+1}'" value="다음페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Report/report.com'" value="글 작성"></input>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
