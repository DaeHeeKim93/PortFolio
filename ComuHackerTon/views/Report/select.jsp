    ...
    <body>
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">${ReportOne.report_title}</strong>
                                </div>

                                <div class="card-body">
                                    <div class="typo-articles">
                                            ${ReportOne.report_context}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <a class="au-btn au-btn-load" href="/Report/report_list_select.com">목록</a>
                    <a class="au-btn au-btn-load" href="/Report/report_select_update.com?report_idx=${ReportOne.report_idx}">글 수정</a>
                    <a class="au-btn au-btn-load" href="/Report/report_delete.com?report_idx=${ReportOne.report_idx}">글 삭제</a>
                </div>
                <div class="col-md-4"></div>
            </div>
        </div>
