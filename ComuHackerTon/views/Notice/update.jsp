...
<html>
    ...
    <body>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <form name="writeForm" id="writeForm" action="/Notice/notice_update.com" method="post">
                ...
                <div class="down">
                    ...
                    <div class="col-md-2">
                        ...
                        <a class="btn btn-warning" id="select_button"  style="font-size : 15px" href="/Notice/notice_list_select.com">목록</a>
                    </div>
                    <div class="col-md=5"></div>
                </div>
            </form>
