...
<html>
    ...
    <body>
        ...
        <!-- Navigation End -->
        <div class="container">
            <h2 class="title-1 m-b-10">신고관리</h2>
            <br/>
            <br/>
            <div clas="row">
                ...
                <div class="col-md-10">
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th align="center">해결자</th>
                                <th align="center">신고날짜</th>
                                <th align="center">해결날짜</th>
                                <th align="center">해결 여부</th>
                                <th align="center">해결/ 미해결 설정</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${ReportList}" var="ReportContents">
                                <tr class="bo_notice">
                                    <td>${ReportContents.report_idx}</td>
                                    <td class="td_subject">
                                        <a href="/Admin/Report/select.com?report_idx=${ReportContents.report_idx}"/>${ReportContents.report_title}
                                    </td>
                                    <td>${ReportContents.report_id}</td>
                                    <td>${ReportContents.clear_id}</td>
                                    <td>${ReportContents.report_date}</td>
                                    <td>${ReportContents.solution_date}</td>
                                    <td align="center" >
                                        <c:if test="${ReportContents.report_status eq 'N'}">
                                            <font color="#FF0000">미해결</font>
                                        </c:if>
                                        <c:if test="${ReportContents.report_status eq 'Y'}">
                                            <font color="#008000">해결</font>
                                        </c:if>
                                    </td>
                                    <td align="center">
                                        <a class="btn btn-success" id="status-button1"  style="font-size : 7px" href="/Admin/Report/status.com?report_idx=${ReportContents.report_idx}&amp;report_status=Y">해결</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="submit" class="au-btn au-btn-load js-load-btn" onclick="location.href='/Admin/Report/report_list_select.com?page=${page-1}'" value="이전페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Admin/Report/report_list_select.com?page=${page+1}'" value="다음페이지"></input>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
