package com.comu.hack.Main.Controller;
    ...
    public String mainPage(HttpSession httpSession, Locale locale, Model model) {
        ...
        try{
            ...
            if(GlobalmemberSession.getId() != null){
                 ...
                 List<Report> ReportList = memberMapper.Report_ListSelection(MainController.GlobalmemberSession.getMember_idx());
                 ...
                 model.addAttribute("ReportList",ReportList); // 신고내역 출력
