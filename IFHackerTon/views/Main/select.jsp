        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                                ...
                                <div class="card-body">
                                    <div class="typo-articles">
                                        <form name="north_form" id="north_form"  method="post">
                                            <textarea id="north_textarea"  style="font-size: 20pt;" name="north_textarea"></textarea>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="south_form" id="south_form"  method="post">
                                        <textarea id="south_textarea" style="font-size: 20pt;"  name="south_textarea"></textarea>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <a class="au-btn au-btn--green" href="/">처음으로</a>
                </div>
                <div class="col-md-3"></div>
            </div>
        </div>
