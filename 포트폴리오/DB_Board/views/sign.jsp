                                ...
                                <form action="/sign_up" method="post" accept-charset="utf-8" spring:htmlEscapedefaultHtmlEscape="true" path="someFormField" htmlEscape="true" >
                                    <div class="sminputs">
                                        <div class="input full">
                                            <label >ID</label>
                                            <input maxlength="15" id="id" name="id" placeholder="ID" size="50" />
                                        </div>
                                    </div>
                                    <div class="sminputs">
                                        <div class="input string optional">
                                            <label >Password</label>
                                            <input maxlength="20" id="password" name="password" placeholder="Password" type="password" size="20" />
                                        </div>
                                        <div class="input string optional">
                                            <label >Nickname</label>
                                            <input maxlength="15" id="nickname" name="nickname" placeholder="Nickname" type="text" size="50" />
                                        </div>
                                    </div>
                                ...
                                <form  action="/login"  method = "post"  accept-charset="utf-8" spring:htmlEscapedefaultHtmlEscape="true" path="someFormField" htmlEscape="true" >
                                    <div class="sminputs">
                                        <div class="input full">
                                            ...
                                            <input class="string optional"  maxlength="15" id="id" name="id" placeholder="ID" size="50" />
                                        </div>
                                    </div>
                                    <div class="sminputs">
                                        <div class="input full">
                                            <label class="string optional" >Password</label>
                                            <input class="string optional" maxlength="20" id="password" name="password" placeholder="Password" type="password" size="20" />
