                        ...
                        <div class="card-body">
                            ...
                            <form action="/Admin/Mail/mailSend.com" method="post" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" aria-required="true" aria-invalid="false" ></input>
                                </div>
                                <div class="form-group">
                                    <label for="cc-name" class="control-label mb-1">이름</label>
                                    <input id="name" name="name" type="text" class="form-control name valid" data-val="true"></input>
                                </div>
                                <div class="form-group">
                                    <label for="cc-name" class="control-label mb-1">전화번호</label>
                                    <input id="telphone" name="telphone" type="text" class="form-control name valid" data-val="true"></input>
                                </div>
                                <div class="form-group">
                                    <label for="cc-name" class="control-label mb-1">건의내용</label>
                                    <textarea id="context" name="context" style="height:300px;" class="form-control name valid" data-val="true"></textarea>
                                </div>
