...
<html>
    ...
    <body>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <form name="writeForm" id="writeForm" action="/Board/board_write.com" method="post">
                <table>
                    <tbody>
                        <tr>
                            <th scope="row">
                            ...
                            <td>
                                <div id="autosave_wrapper">
                                    <input type="text" class="frm_input required" id="board_title" name="board_title" maxlength="255"/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="wr_content">
                                <textarea name="board_context" id="board_context"></textarea>
                            </td>
                        </tr>
                        <!--관리자 확인여부 체크 -->
                        <tr>
