            ...
            <div clas="row">
                ...
                <div class="col-md-10">
                        ...
                        <tbody>
                            <c:forEach items="${NoticeList}" var="NoticesContents">
                                <tr class="bo_notice">
                                    ...
                                    <td class="td_subject">
                                        <a href="/Notice/select.com?notice_idx=${NoticesContents.notice_idx}"/>${NoticesContents.notice_title}
                                    </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Notice/notice_list_select.com?page=${page-1}'" value="이전페이지"></input>
                            <input type="submit" class="au-btn au-btn-load js-load-btn"  onclick="location.href='/Notice/notice_list_select.com?page=${page+1}'" value="다음페이지"></input>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                </div>
